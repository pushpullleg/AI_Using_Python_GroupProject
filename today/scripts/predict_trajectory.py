...
def load_model():
    try:
        model = joblib.load('final_trajectory_model.joblib')
        return model
    except FileNotFoundError:
        print("Error: Model file 'final_trajectory_model.joblib' not found.")
        sys.exit(1)
...
def load_data():
    try:
        ...
        print("Error: Data file 'trajectory_ml_ready_advanced.csv' not found.")
        sys.exit(1)
